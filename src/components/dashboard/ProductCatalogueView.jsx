              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b border-slate-100 bg-slate-50/30">
                    <TableHead className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Product</TableHead>
                    <TableHead className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Base SKU</TableHead>
                    <TableHead className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Category</TableHead>
                    <TableHead className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider text-center">Variants</TableHead>
                    <TableHead className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider text-center">Stock</TableHead>
                    <TableHead className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider text-right">Status</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody className="divide-y divide-slate-50">
                  {products.map((product) => (
                    ...
                    >
                      ...
                      <TableCell className="px-6 py-4 text-sm text-slate-600">{product.sku}</TableCell>
                      <TableCell className="px-6 py-4 text-sm text-slate-600">{product.category}</TableCell>
                      <TableCell className="px-6 py-4 text-sm text-slate-600 text-center font-medium">{product.variants.toString().padStart(2, '0')}</TableCell>
                      <TableCell className="px-6 py-4 text-sm text-slate-600 text-center font-medium">{product.stock}</TableCell>
